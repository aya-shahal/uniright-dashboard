...
export default class FeesAddUpdate extends CoreEngine {
    constructor(props) {
        super(props);
        this.state = {
            isLoading: true,
    ...
    render() {
        ...
        const {loading,isLoading,student,
            note,
            paymentamounttype,studentlist,  paymenttype  ,
            invoicedate,amount,
                            ...
                            <AvForm  onValidSubmit={() =>this.handleValidSubmit()} className="form-horizontal" id="TypeValidation">
                                <Card>
                                    ...
                                    <CardBody>
                                        ...
                                        <SelectRow label={strings.feestype}  name="feestype"  defaultValue={feestype}  data={feestypelist} changeInput={this.changeInput.bind(this)} />
                                       <FormRow label={strings.invoicedate}  name="invoicedate" type={"date"} data={invoicedate.toString()} changeInput={this.changeInput.bind(this)} />
                                        ...
                                        <Checkboxrow label="Paid" name="paid" data={paid}  changeInput={this.changeInput.bind(this)} />
                                    </CardBody>
