...
class FromResponseList extends CoreEngine {
                    ...
                    <Row>
                        <Col md="12">
                            <Card>
                                ...
                                <CardHeader>
                                    <CardTitle tag="h4" className="pull-left">{strings.list}</CardTitle>
...
export default connect(null, mapDispatchToProps)(FromResponseList);
