...
class ScheduleList extends CoreEngine {
            ...
            this.setState({
                    ...
                    dataSource: response.data.data.map((item, key) => {
                        return {
                            ...
                            data:item,
                            day: item.day ,
                            class: item.classx && item.classx.name  ,
                            teachermatier:item.teachermatier && item.teachermatier.matier.name,
    ...
    render() {
        ...
        let columns = [
            ...
            {
                Header: strings.class,
                accessor: "class"
            },
            {
                Header: strings.teachermatier,
                accessor: "teachermatier"
            },
...
export default connect(null, mapDispatchToProps)(ScheduleList);
